    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    <?= form_open_multipart('admin/edit-pengguna/' . $id, ['class' => 'form-horizontal form-label-left']) ?>
                        ...
                        <div class="item form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <?php  
                                    $opt[''] = 'Pilih Role';
                                    foreach ($role as $i => $row)
                                    {
                                        $opt[$row->id] = $row->role;
                                    }
                                    echo form_dropdown('id_role', $opt, $pengguna->id_role, ['class' => 'form-control col-md-7 col-xs-12', 'required' => 'required']);
                                ?>
                            </div>
                        </div>
                        <div class="item form-group">
