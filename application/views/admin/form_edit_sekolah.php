				...
				<div class="x_content">
					<?= form_open_multipart('admin/edit-sekolah/' . $id, ['class' => 'form-horizontal form-label-left']) ?>
						...
						<div class="item form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<input value="<?= $sekolah->jarak ?>" id="nama_sekolahjarak" class="form-control col-md-7 col-xs-12" data-validate-length-range="2" name="jarak" required="required" type="text"/>
							</div>
						</div>
						<div class="item form-group">
